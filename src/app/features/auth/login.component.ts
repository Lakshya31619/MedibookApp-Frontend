    ...
    <div class="min-h-screen bg-gradient-to-br from-navy-50 to-white flex items-center justify-center p-4">
      <div class="w-full max-w-md page-enter">
        ...
        <div class="text-center mb-8">
          ...
          <h1 class="text-3xl font-serif text-navy-700">Welcome back</h1>
        ...
        <div class="card shadow-lg border-0">
          ...
          <div class="flex items-center gap-3 mb-6">
            ...
            <span class="text-gray-400 text-xs">or continue with email</span>
            <div class="flex-1 h-px bg-gray-200"></div>
          </div>
          ...
          <p class="text-center text-sm text-gray-500 mt-6">
            ...
            <a routerLink="/register" class="text-navy-700 font-medium hover:underline">Create one</a>
          </p>
        </div>
      </div>
    </div>
